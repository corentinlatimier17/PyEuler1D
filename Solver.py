...
class TransientSolver:
    ...
    def solve(self):
        ...
        plt.plot(self.mesh.coordinates[self.mesh.innerCellsIndexes] , self.Q.rhouA[self.mesh.innerCellsIndexes] /(self.Q.rhoA[self.mesh.innerCellsIndexes] *compute_sound_velocity(self.Q, self.mesh)))
        plt.show()
